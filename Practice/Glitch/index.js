...
function drawLine(x0, y0, x, y) {
  ...
  function time() {
    amount += 0.5;
    px.strokeStyle = "black";
    px.moveTo(x0, y0);
    px.lineTo(x0 + (x - x0) * amount, y0 + (y - y0) * amount);
    px.stroke();
    if (amount > (0.5 * interval) / 100) px.stroke();
...
for (var i = 1; i < body.length; ++i) {
  if (body[i][0] == 0 && body[1] == 0) {
    i++;
    px.moveTo(body[i][0], body[i][1]);
  } else {
...
for (var i = 1; i < lips.length; ++i) {
  if (lips[i][0] == 0 && lips[1] == 0) {
    i++;
    px.moveTo(lips[i][0], lips[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
...
for (var i = 1; i < left_eye.length; ++i) {
  if (left_eye[i][0] == 0 && left_eye[1] == 0) {
    i++;
    px.moveTo(left_eye[i][0], left_eye[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
...
for (var i = 1; i < right_eye.length; ++i) {
  if (right_eye[i][0] == 0 && right_eye[1] == 0) {
    i++;
    px.moveTo(right_eye[i][0], right_eye[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
...
for (var i = 1; i < hair.length; ++i) {
  if (hair[i][0] == 0 && hair[1] == 0) {
    i++;
    px.moveTo(hair[i][0], hair[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
...
for (var i = 1; i < nose.length; ++i) {
  if (nose[i][0] == 0 && nose[1] == 0) {
    i++;
    px.moveTo(nose[i][0], nose[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
...
for (var i = 1; i < potatos.length; ++i) {
  if (potatos[i][0] == 0 && potatos[1] == 0) {
    i++;
    px.moveTo(potatos[i][0], potatos[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
...
for (var i = 1; i < potatos2.length; ++i) {
  if (potatos2[i][0] == 0 && potatos2[1] == 0) {
    i++;
    px.moveTo(potatos2[i][0], potatos2[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
...
for (var i = 1; i < shirt.length; ++i) {
  if (shirt[i][0] == 0 && shirt[1] == 0) {
    i++;
    px.moveTo(shirt[i][0], shirt[i][1]);
  } else {
    setTimeout(b, interval);
    function b() {
      drawLine(
